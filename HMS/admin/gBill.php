...
if(isset($_POST['apply'])){
    ...
    $tfees = $_POST['total'];
        ...
        $query = "INSERT INTO bill(b_id,p_id,d_id,p_name,d_name,a_date,t_date,dfees,mfees,total) 
        VALUES ('$id','$p_id','$d_id','$pname','$dname','$date',NOW(),'$dfees','$mfees','$tfees')";
        ...
        <form  method="post">
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <input  onblur="findTotal()" type="number" name="mfees" id="fees2"  placeholder="Enter Medical Fees" r >
                </div>
